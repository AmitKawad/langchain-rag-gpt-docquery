...
const txtFilename = "iebe108";
const question = "What does Vikram Seth compare to the quills of a porcupine?";
...
export const runWithEmbeddings = async () => {
    ...
    const model = new OpenAI({
        modelName: 'gpt-3.5-turbo', // Specify the model explicitly
    });
